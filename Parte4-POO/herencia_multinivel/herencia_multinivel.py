...
# Ejemplo de uso
mi_robot_inteligente = RobotInteligente(
    marca="AI Tech", tipo="Android", nivel_inteligencia=5
)
print(mi_robot_inteligente.encender())  # Método heredado de Maquina
print(mi_robot_inteligente.saludar())  # Método heredado de Robot
print(mi_robot_inteligente.tomar_decision())  # Método propio de RobotInteligente
